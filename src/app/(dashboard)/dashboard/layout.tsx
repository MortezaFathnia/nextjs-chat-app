                ...
                {sidebarOptions.map((option) => {
                  ...
                  return (
                    <Link
                      href={option.href}
                      key={option.id}
                      className='text-gray-700 hover:text-indigo-600 hover:bg-gray-50 flex
                   group gap-3 rounded-md p-2 text-sm leading-6 font-semibold'
                    >
                      <span
                        className='text-gray-400 border-gray-200 group-hover:border-indigo-600
                    group-hover:text-indigo-600
                    flex h-6 w-6 shrink-0 items-center
                    justify-center rounded-lg text-[0.625rem]
